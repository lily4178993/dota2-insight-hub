  ...
  return (
    ...
    >
      <div
        ...
        className={`opacity-50 parallax-bg grayscale-50 ${
          isSliderModuleArray && sliderModule.includes('Parallax')
      ...
      {slidesData.map((slide) => (
        ...
        >
          <div className="size-full flex flex-col 2xl:flex-row 2xl:items-center justify-center font-light text-center md:text-left text-balance bg-gradient-to-t from-black from-10% py-10 md:px-16">
            <p
              className={`2xl:w-[850px] text-4xl md:text-5xl ${
                isSliderModuleArray && sliderModule.includes('Parallax')
            ...
            <p
              className={`md:w-[850px] md:text-xl mt-4 2xl:mt-0 ${
                isSliderModuleArray && sliderModule.includes('Parallax')
